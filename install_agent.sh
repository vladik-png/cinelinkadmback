...
echo -e "\n\e[1;33m[1/3] Purging legacy services...\e[0m"
draw_progress 1
...
echo -e "\n\e[1;33m[2/3] Installing new modules...\e[0m"
draw_progress 1.5
register_service() {
    local name=$1
    local binary=$2
...
echo -e "\n\e[1;33m[3/3] Verifying network stack...\e[0m"
draw_progress 2
if sudo ss -tulpn | grep -q ":8082"; then
    echo -e "  \e[1;32m✔ SUCCESS: Port 8082 is ACTIVE!\e[0m"
    # xdg-open "http://127.0.0.1:8082/system-metrics" >/dev/null 2>&1 &
else
    echo -e "  \e[1;31m✖ ERROR: Port 8082 not responding.\e[0m"
fi
